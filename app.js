...
// //   : ['https://fabulous-choux-ce3092.netlify.app'];
...
// const allowedOrigins = process.env.ALLOWED_ORIGINS
//   ? process.env.ALLOWED_ORIGINS.split(',')
//   : ['https://fabulous-choux-ce3092.netlify.app', 'https://loc8r-shiny-daifuku-4e862b.netlify.app'];
...
// }));
// app.options('*', cors()); // Preflight requests 허용
